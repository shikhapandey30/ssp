# -*- encoding: utf-8 -*-
# stub: activeadmin 1.4.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<inherited_resources>.freeze, [">= 1.9.0"])
      ...
      s.add_runtime_dependency(%q<ransack>.freeze, [">= 1.8.7"])
      ...
      s.add_dependency(%q<inherited_resources>.freeze, [">= 1.9.0"])
      ...
      s.add_dependency(%q<ransack>.freeze, [">= 1.8.7"])
